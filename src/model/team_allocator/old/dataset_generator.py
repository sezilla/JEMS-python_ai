...
department_teams = {
    1: [1, 2, 3, 4, 5, 6, 37],          #Catering
    2: [7, 8, 9, 10, 11, 12, 38],       #Hair and Makeup
    3: [13, 14, 15, 16, 17, 18, 39],    #Photo and Video
    4: [19, 20, 21, 22, 23, 24, 40],    #Designing
    5: [25, 26, 27, 28, 29, 30, 41],    #Entertainment
    6: [31, 32, 33, 34, 35, 36, 42],    #Coordination
}
